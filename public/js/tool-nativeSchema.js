 ...
 *
 * buyNow?type=mall&goodskuId=2195605685482496
 * goodsDetail?type=mall&goodskuId=2195605685482496
 */
...
(function(root, factory){
    ...
    var AppConfig = {
        ...
        // 唤起失败时的跳转链接
        FAILBACK: {
            ANDROID: "https://a.app.qq.com/o/simple.jsp?pkgname=com.jlhm.personal",
            IOS:"https://itunes.apple.com/cn/app/id1156008352?l=zh&ls=1&mt=8"
        },

        // Android apk 相关信息
        APK_INFO: {
            PKG: "com.jlhm.personal",
    ...
    var isAndroidChrome = (ua.match(/Chrome\/([\d.]+)/) || ua.match(/CriOS\/([\d.]+)/) || ua.match(/Lenovo/ig))
    ...
    return {
        ...
        mixinConfig: function(config){
            ...
            if(typeof config.DOWN_LOAD_PAGE == 'boolean'){
            	AppConfig.DOWN_LOAD_PAGE = config.DOWN_LOAD_PAGE ;	
            }
        },
        /**
...
//                           "end";
        ...
        loadSchema: function(config){
            ...
            loadTimer = setTimeout(function() {
                ...
                /*console.log(不跳转下载页面);*/
				if(!AppConfig.DOWN_LOAD_PAGE){return false;}
...
function clickBuy(id,type) {
	nativeSchema.loadSchema({ schema: 'buyNow?type='+type+'&goodskuId='+id});
};
function openApp() {
